...
static const CharFrame char_bf_frame[] = {
	...
	{BF_ArcMain_BFNyaw,  {  0,   0, 128, 128}, { 48,  99}}, //12 up 1
	{BF_ArcMain_BFNyaw,  {128,   0, 128, 128}, { 48,  99}}, //13 up 2
	{BF_ArcMain_BFNyaw, {  0,   0, 128, 128}, {  53, 105}}, //14 up miss 1
	{BF_ArcMain_BFNyaw, {128,   0, 128, 128}, {  53, 105}}, //15 up miss 2
...
static const Animation char_bf_anim[PlayerAnim_Max] = {
	...
	{2, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},       //PlayerAnim_Sweat
	{2, (const u8[]){ASCR_CHGANI, CharAnim_Idle}},       //PlayerAnim_Sweat
	{1, (const u8[]){ 25, 26, 26, ASCR_BACK, 1}},         //PlayerAnim_Peace
	
	{5, (const u8[]){27, 28, 29, 30, 29, 29, 29, 29, 29, 29, ASCR_CHGANI, PlayerAnim_Dead1}}, //PlayerAnim_Dead0
		...
		if (stage.note_scroll >= 0)
		{
			switch (stage.stage_id)
			{
				case StageId_1_4: //Tutorial peace
				  if ((stage.flag & STAGE_FLAG_JUST_STEP) && stage.song_step >= 1130)
                 	{
				   ...
				   if ((stage.song_step) == 1133)
                 	character->set_anim(character, PlayerAnim_BFNyaw);

				   if ((stage.flag & STAGE_FLAG_JUST_STEP) && stage.song_step >= 1150)
                 	{
	                  this->character.focus_x = FIXED_DEC(-40,1);
	                  this->character.focus_y = FIXED_DEC(-65,1);
