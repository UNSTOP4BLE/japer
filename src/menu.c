...
static const char *funny_messages[][2] = {
    {"THE JAPI", "EL JAPI"},
	{"PLAYING ON EPSXE HUH", "WE KINDA TOLD YA NOT TO"},
    {"HAXEFLIXEL PSX", "LOL WAT"},
    {"GET ME TO STOP", "TRY"},
    {"CANT STOP", "WONT STOP"},
    {"U DOWNLOADED IT", "PLAY IT WE WONT BITE"},
    {"IM UNSTOPPABLE", "IM A GOOD FLEA TOO"},
    {"A WEEK OF DEV", "SHOULD BE GOOD NOW DOE"},
    {"PLAYING ON FRIDAY", "HOW COINCIDENTIAL"},
    {"OPEN SOURCE", "FOREVER"},
    {"GIMME A SEC", "LMAO"},
    {"IM STILL", "DRINKING ENERGADE"},
    {"PSXKAPI BY THIRTEENZ", "WHAT YOU GONNA DO"},
    {"ITS A PORT", "ITS WORSE"},
    {"YOU KINDA SMELL", "LIKE A BAKA"},
    {"NINTENDO DRIFT LMAO", "NO U"},
    {"BALLS FISH", "BALLS FISH"},
    {"SMELL THAT", "ITS EL JAPI"},
	{"FUZZY DISTORTION", "YES"},
    {"MR GAME AND WATCH", "HE IS HERE LOL"},
    {"MAKING GF WAS FUN", "THREE HOURS LOL"},
    {"SWAGSHIT", "MONEYMONEY"},
};
			...
			else
			{
                ...
                //Fallthrough
                    ...
                    case 1:
                        ...
                        menu.font_bold.draw(&menu.font_bold, "FLEAANIMATES", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 16, FontAlign_Center);
                        menu.font_bold.draw(&menu.font_bold, "GTHREEYT",   SCREEN_WIDTH2, SCREEN_HEIGHT2,      FontAlign_Center);
						menu.font_bold.draw(&menu.font_bold, "IGORSOU",   SCREEN_WIDTH2, SCREEN_HEIGHT2 +16,      FontAlign_Center);
                        menu.font_bold.draw(&menu.font_bold, "CUCKYDEV",      SCREEN_WIDTH2, SCREEN_HEIGHT2 + 32, FontAlign_Center);
                        break;
                    
                    case 7:
                        menu.font_bold.draw(&menu.font_bold, "EL JAPI",    SCREEN_WIDTH2, SCREEN_HEIGHT2 - 32, FontAlign_Center);
                ...
                //Fallthrough
                    case 14:
                        menu.font_bold.draw(&menu.font_bold, "KAPI", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
                //Fallthrough
                    case 13:
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{NULL, StageId_1_1, "B B BREAK DOWN", {"WOCKY", "BEATHOVEN", "HAIRBALL", "NYAW"}},
				{"1", StageId_2_1, "PLEASE NERF UP B", {"FLATZONE", NULL, NULL}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				//{StageId_4_4, "TEST"},
				{StageId_1_1, "WOCKY"},
				{StageId_1_2, "BEATHOVEN"},
				{StageId_1_3, "HAIRBALL"},
				{StageId_1_4, "NYAW"},
				{StageId_2_2, "FUZZY DISTORTION"},
				{StageId_2_1, "FLATZONE"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "	OG VS KAPI MOD", false},
				{StageId_Clwn_2, "BBPANZU", false},
				{StageId_Clwn_2, "MIKEGENO", false},
				{StageId_Clwn_2, "PAPERKITTY", false},
				...
				{StageId_Clwn_1, "	SPRITES AND BACKGROUNDS", false},
				{StageId_Clwn_1, "FLEAANIMATES", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "	FUZZY DISTORTION CHART", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "	CODING", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "IGORSOU3000", false},
				{StageId_Clwn_1, "  KAPI SPECIAL ", false},
				{StageId_Clwn_1, "  ANIMATIONS", false},
				{StageId_Clwn_1, "IGORSOU3000", false},
				{StageId_Clwn_1, "	PLAYTESTING", false},
				{StageId_Clwn_1, "JOHN PAUL", false},
				{StageId_Clwn_1, "FLEAANIMATES", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "	SCREENSHOTS", false},
				{StageId_Clwn_1, "FLEAANIMATES", false},
				{StageId_Clwn_1, "	GAME AND WATCH WEEK", false},
