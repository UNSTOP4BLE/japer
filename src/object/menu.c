...
static const char *funny_messages[][2] = {
	...
	{"PLAYING ON EPSXE HUH", "WELL TOLD YA NOT TO"},
	{"NEXT IN LINE", "ATARI"},
	{"HAXEFLIXEL", "COME ON"},
	{"HAHAHA", "I DONT CARE"},
	{"GET ME TO STOP", "DO IT"},
	{"FNF MUKBANG GIF", "THATS UNRULY"},
	{"OPEN SOURCE", "FOREVER"},
	{"ITS A PORT", "ITS SHITTY WORSE"},
	{"WOW GATO", "WOW GATO"},
...
void Menu_Tick(void)
{
		...
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					...
					case 15:
						menu.font_bold.draw(&menu.font_bold, "FULL WEEK PSX", SCREEN_WIDTH2, SCREEN_HEIGHT2 + 8, FontAlign_Center);
				//Fallthrough
					case 14:
	...
	//Fallthrough
		...
		{
			static const char *gamemode_strs[] = {"NORMAL", "SWAP", "TWO PLAYERS"};
			static const struct
			{
				enum
				{
